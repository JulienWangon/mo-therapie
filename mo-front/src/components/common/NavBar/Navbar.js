            ...
            <div className="canvas-footer">
              <div className="infoContainer">
                ...
                <div className="permTel">
                  <p className="permTelText">Rendez-vous téléphonique gratuit et sans engagement: <a className="permLien" href="https://www.crenolibre.fr/prendre-rdv/89991_psychopraticienne">Ici</a></p>
                </div>
                <div className="contactNavbar">
                  <i className="fa fa-2x fa-map-marker-alt"></i>
