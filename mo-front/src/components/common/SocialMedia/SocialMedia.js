...
const SocialMedia = ({ className, colorStyleIcone,marginStyle }) => {
  return (
    <div className={className}>
        <a href="https://www.instagram.com/marine.ottaviani?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className={`socialContainer containerOne ${colorStyleIcone} ${marginStyle}`} target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.facebook.com/explorationdescorps" className={`socialContainer containerTwo ${colorStyleIcone} ${marginStyle}`} target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.linkedin.com/in/marine-ottaviani-b6a1b1249/" className={`socialContainer containerThree ${colorStyleIcone} ${marginStyle}`} target="_blank" rel="noopener noreferrer">
